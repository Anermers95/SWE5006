...
const fetchBookedSlots = async () => {
  ...
  try {
    ...
    const bookingsForDate = response.data.filter((booking: any) => {
      // Handle ISO 8601 format: "2025-03-02T08:00:00.000Z"
    ...
    bookingsForDate.forEach((booking: any) => {
      ...
      const startTimeISO = booking.start_time; // e.g. "2025-03-02T08:00:00.000Z"
      const endTimeISO = booking.end_time;     // e.g. "2025-03-02T10:00:00.000Z"
      
      // Convert to Date objects to get hours
      const startTime = new Date(startTimeISO);
      const endTime = new Date(endTimeISO);
      
      // Extract hours in local time
