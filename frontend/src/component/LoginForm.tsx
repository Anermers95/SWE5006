  ...
  return (
    <div className="w-full max-w-2xl mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
      ...
      <div className="p-8"> {/* Increased padding */}
        ...
        {message && (
            <div className={`flex w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 mt-4 ${success ? 'border border-emerald-500' : ''}`}>
              ...
              <div className="px-4 py-2 -mx-3 flex justify-between w-full">
                ...
                <button onClick={() => setMessage("")} className="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white font-bold">✖</button>
              </div>
            </div>
          )}
