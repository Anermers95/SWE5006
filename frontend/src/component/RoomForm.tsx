    ...
    <div className="max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex items-center items-start mb-4">
          ...
          <label htmlFor="checkbox-1" className="text-sm ml-3 font-medium text-gray-400">Is Active</label>
        </div>
        <button type="submit" className="text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
          {id ? "Update Room" : "Create Room"}
        </button>
      </form>
